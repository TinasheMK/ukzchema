...
return [
    ...
    */
    ...
    'additional_js' => [
        'js/libs/voyager_scripts/dataTables.buttons.min.js',
        'js/libs/voyager_scripts/buttons.flash.min.js',
        'js/libs/voyager_scripts/jszip.min.js',
        'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.65/pdfmake.min.js',
        'js/libs/voyager_scripts/vfs_fonts.js',
        'js/libs/voyager_scripts/buttons.html5.min.js',
        'js/libs/voyager_scripts/buttons.print.min.js',
    ],
