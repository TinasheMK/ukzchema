              ...
              [
                _c("div", { staticClass: "footer-widget-area mb-70" }, [
                  ...
                  _c("ul", [
                    ...
                    _c("li", [
                      _c("a", { attrs: { href: "#", target: "_blank" } }, [
                        _vm._v("Bigshop Ecommerce")
                      ])
                    ]),
                    _vm._v(" "),
                    _c("li", [
                      _c("a", { attrs: { href: "#", target: "_blank" } }, [
                        _vm._v("Classy Multipurpose")
                      ])
                    ]),
                    _vm._v(" "),
                    _c("li", [
                      _c("a", { attrs: { href: "#", target: "_blank" } }, [
                        _vm._v("Educamp Education")
                      ])
                    ]),
                    _vm._v(" "),
                    _c("li", [
                      _c("a", { attrs: { href: "#", target: "_blank" } }, [
                        _vm._v("Champ Portfolio")
                      ])
                    ])
                  ])
                ])
                ...
                [
                  _c("div", { staticClass: "btn-group dropup" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "btn radix-btn-2 dropdown-toggle text-white",
                        attrs: {
                          type: "button",
